...
<Snippet file="zh/types/order-fields.mdx" />
...
以 `postArb` 下的订单，会在其[用户推送](/zh/pages/streaming/user-feed)和[行情推送](/zh/pages/streaming/price-feed)更新中带有 `isPostArb: true`；其他订单类型会省略该字段。下单响应本身不包含该标志。
...
<Snippet file="zh/types/order-error.mdx" />
