...
返回某联赛的全部活跃赛事。响应**不**包含订单簿或任何价格 — 请调用 [获取订单簿](/zh/pages/rest/markets/get-orderbook) 获取。
...
<ParamField query="league" type="string" required>
  来自 [获取联赛](/zh/pages/rest/markets/get-leagues) 的联赛代码。使用特殊值 `upcoming` 可获取跨联赛的全部即将开赛赛事。
</ParamField>
