...
## Errores por orden frente a errores HTTP {#per-order-errors-vs-http-errors}
...
## Actualizaciones en tiempo real {#real-time-updates}
...
## Colección heredada de Postman {#legacy-postman-collection}
