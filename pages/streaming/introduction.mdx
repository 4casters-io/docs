...
There is no separate API key. Log in with your 4Casters username and password
by calling the `/user/login` endpoint of the 4Casters REST API. The response
includes a token you can use here. See [Authentication](/pages/authentication)
for token lifetime and rotation.
