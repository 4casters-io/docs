...
**`post`** rejects an order that would match resting liquidity (for example, best offer **+100** and you try to post **+100**). **`postArb`** allows that situation when your odds are within **1%** of the order you would match — so the same **+100** post can succeed as **`postArb`**. If your price is too far from the resting quote (e.g. best offer **+200** but you send **+190**), **`postArb`** is rejected; a price around **+198** is near the limit vs **+200**. Use **`orderType": "postArb"`** in the order object the same way as **`post`** or **`fillOrKill`**.
