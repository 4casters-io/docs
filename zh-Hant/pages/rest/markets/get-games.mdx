...
返回某聯賽的全部活躍賽事。響應**不**包含訂單簿或任何價格 — 請呼叫 [獲取訂單簿](/zh-Hant/pages/rest/markets/get-orderbook) 獲取。
...
<ResponseField name="data.games" type="array">
  <Expandable title="Game">
    ...
    <ResponseField name="cheapDataUID"   type="string">賽事的穩定跨系統標識（用於盤口關聯）。</ResponseField>
